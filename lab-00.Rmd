...
```{r setup-tibble}
team_data <- tibble(
  name = c("jason ", "wayne", "Jerry", 
           "Matias", "James"),
  github_username = c("JasonBi615", "Flandrelectron", "JerryL123", 
                      "matiasLanber", "James114Jin"), 
  colour = c( "pink", "black", "Blue" 
             "blue", "black"),
  hobby = c("video games", "video games", "video games", 
            "footable", "pingpong"),
  favourite_number = c(8, 6, 5, 5, 7)
  )
